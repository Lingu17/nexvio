...
export function meta({ }: Route.MetaArgs) {
    return [{ title: "Terms of Service | Nexvio" }];
}
...
export default function Terms() {
    return (
        <div className="mx-auto max-w-[1440px] px-4 py-32 sm:px-6 lg:px-8 text-center relative overflow-hidden min-h-screen bg-[#0A0A14] flex flex-col justify-center items-center">
            <div className="absolute top-[20%] right-[20%] w-[400px] h-[400px] bg-violet-500/10 blur-[120px] rounded-full pointer-events-none"></div>
            <FileText className="w-20 h-20 text-violet-400 mb-8 relative z-10 animate-bounce" />
            <h1 className="text-5xl font-black text-white mb-6 relative z-10">Terms of Service</h1>
