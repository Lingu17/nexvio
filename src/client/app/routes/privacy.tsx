...
export function meta({ }: Route.MetaArgs) {
    return [{ title: "Privacy Policy | Nexvio" }];
}
...
export default function Privacy() {
    return (
        <div className="mx-auto max-w-[1440px] px-4 py-32 sm:px-6 lg:px-8 text-center relative overflow-hidden min-h-screen bg-[#0A0A14] flex flex-col justify-center items-center">
            <div className="absolute top-[20%] left-[20%] w-[400px] h-[400px] bg-cyan-500/10 blur-[120px] rounded-full pointer-events-none"></div>
            <ShieldAlert className="w-20 h-20 text-cyan-400 mb-8 relative z-10 animate-bounce" />
            <h1 className="text-5xl font-black text-white mb-6 relative z-10">Privacy Policy</h1>
